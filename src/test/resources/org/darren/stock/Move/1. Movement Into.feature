...
@asciidoc
  Feature: Movement Endpoint
    ...
    * Businesses maintain control and visibility over inventory at all times.
    ...
    Stock movements occur for a variety of operational, logistical, and strategic reasons. The table below outlines the most common scenarios:
    ...
    * Damage and Obsolescence: Moving damaged or outdated stock for disposal.
    | Promotional and Seasonal   a| * Seasonal Demand: Adjusting inventory based on seasonal trends.
    * Promotional Campaigns: Sending stock for events or promotions.
    | Regulatory and Compliance  a| * Taxation or Legislative Zones: Complying with regional tax or legal requirements.
    * Quality Inspections: Transferring goods for quality control checks.
    | Emergency or Contingency   a| * Emergency Replenishment: Addressing unexpected demand surges.
    * Disaster Recovery: Protecting inventory during risks such as natural disasters.
    |===

    === Key Elements of Stock Movement
    ...
    * Supporting planning and operational efficiency through precise tracking of inventory movements.
    ...
    This functionality empowers organisations to optimise inventory management, minimise errors, and maintain consistency across their supply chain processes.
